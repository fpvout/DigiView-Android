...
public class ExoPlayerRTMP extends ExoPlayerRTMPBase {

    private SrsFlvMuxer srsFlvMuxer;

    public ExoPlayerRTMP(Context context, SimpleExoPlayer player, boolean useOpengl, ConnectCheckerRtmp connectChecker) {
        super(context, player, useOpengl);
